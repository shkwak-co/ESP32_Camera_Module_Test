...
app_main (void)
{
  ...
  std::list < dl::detect::result_t > &candidates_316 = s1.infer ((uint8_t *) image_bgr_316_1,
                                                                 {
                                                                 240, 320, 3});
  std::list < dl::detect::result_t > &results_316 = s2.infer ((uint8_t *) image_bgr_316_1,
                                                              {
                                                              240, 320, 3}, candidates_316);
  assert (results_316.size () == 1);
  vector < int >landmarks_316_1 = results_316.front ().keypoint;

  std::list < dl::detect::result_t > &candidates_319 = s1.infer ((uint8_t *) image_bgr_319_1,
                                                                 {
                                                                 240, 320, 3});
  std::list < dl::detect::result_t > &results_319 = s2.infer ((uint8_t *) image_bgr_319_1,
                                                              {
                                                              240, 320, 3}, candidates_319);
  ...
  image_rgb888_316_1.set_element ((uint8_t *) image_bgr_316_1).set_shape (
                                                                           {
                                                                           240, 320, 3}).set_auto_free (false);

  Tensor < uint8_t > image_rgb888_319_1;
  image_rgb888_319_1.set_element ((uint8_t *) image_bgr_319_1).set_shape (
                                                                           {
                                                                           240, 320, 3}).set_auto_free (false);

  Tensor < uint8_t > aligned_face_rgb888_316_2;
  aligned_face_rgb888_316_2.set_element ((uint8_t *) aligned_face112_image_bgr_316_2).set_shape (
                                                                                                  {
                                                                                                  112, 112,
                                                                                                  3}).
    set_auto_free (false);
  ...
  aligned_face_rgb888_316_3.set_element ((uint8_t *) aligned_face112_image_bgr_316_3).set_shape (
                                                                                                  {
                                                                                                  112, 112,
                                                                                                  3}).
    set_auto_free (false);
  ...
  aligned_face_rgb888_319_2.set_element ((uint8_t *) aligned_face112_image_bgr_319_2).set_shape (
                                                                                                  {
                                                                                                  112, 112,
                                                                                                  3}).
    set_auto_free (false);
  ...
  aligned_face_rgb888_319_3.set_element ((uint8_t *) aligned_face112_image_bgr_319_3).set_shape (
                                                                                                  {
                                                                                                  112, 112,
                                                                                                  3}).
    set_auto_free (false);
  ...
  cout << "[recognition result] id: " << recognize_316.id << ", name: " << recognize_316.
    name << ", similarity: " << recognize_316.similarity << "\n";

  face_info_t recognize_319 = recognizer.recognize (aligned_face_rgb888_319_2);
  cout << "[recognition result] id: " << recognize_319.id << ", name: " << recognize_319.
    name << ", similarity: " << recognize_319.similarity << "\n";
